...
public class XaJmsJpaBootstrapIT extends KarafSupportIT {
	@Inject
	@Filter("(camel.context.name=xa-jms-jpa)")
	protected CamelContext camelContext;

	@Configuration
	public Option[] config() {
		List<Option> config = karafBase();
		config.add(keepRuntimeFolder());
	...
	public void testInstallation() throws Exception {
		assertFeatureInstalled("xa-jms-jpa-blueprint", System.getProperty("project.version"));
		assertBundleInstalled("be.arndep.camel.xa-jms-jpa-blueprint", Bundle.ACTIVE);
	}
